...
st.set_page_config(page_title="מערכת משמרות מאובטחת", layout="centered")

# --- הגדרת סיסמאות (תוכל לשנות אותן כאן) ---
PASSWORDS = {
    "ליהיא בן יאיר": "1234",
    "משה בן יאיר": "5678"
}
...
# בדיקה האם הסיסמה נכונה
if password_input == PASSWORDS[user]:
    st.success(f"שלום {user.split()[0]}, זוהה חיבור מאובטח.")
    ...
    # הצגת היסטוריה אישית רק אחרי כניסה
    st.divider()
    ...
    st.warning("אנא הכנס קוד כדי לצפות בנתונים.")
